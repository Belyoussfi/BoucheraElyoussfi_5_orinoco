...
<div class="recap-commande">
    ...
    <div>
        <p>Nous vous remercions pour votre commande numéro <span class="bold">${orderId}</span> a bien été enregistrée.</p>
        <p>Le montant total de votre commande est de: <span class="bold">${prixTotal}€</span>.</p>
        <p>Au plaisir de vous revoir très prochainement sur notre site.</p>
    </div>
</div>
`;
